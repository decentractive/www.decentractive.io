      ...
      <div className="items-center text-center">
        <h1 className="text-3xl font-extrabold tracking-tight sm:text-5xl">
          <span className="hidden sm:block align-top text-balance">
            Welcome back! <br />
            Ready to leave another verified review?
          </span>
        ...
        <p className="mt-6 leading-7 sm:text-lg sm:leading-8">
          <span className="hidden sm:block">
            <span className="inline-block text-balance align-top">
              Add and share your voice and experience to our community of
              trusted reviewers.
            </span>
          </span>
          <span className="sm:hidden">
            Add and share your voice and experience to our community of trusted
            reviewers.
          </span>
        </p>
        <div className="mt-10 sm:flex sm:items-center sm:justify-center sm:gap-x-4">
          ...
          <Button variant="link">
            <Link className="flex" href="app/review/add">
